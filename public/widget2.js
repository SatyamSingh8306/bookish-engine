...
; (function () {
    ...
    class AIChatWidget {
        ...
        #ai-chat-close {
        background: none; border: none; color: #00ffff; font-size: 20px;
        cursor: pointer; opacity: 0.7; transition: opacity 0.2s;
        }
        #ai-chat-close:hover { opacity: 1; }
        #ai-chat-messages {
        flex: 1; overflow-y: auto; padding: 15px; font-size: 14px;
        -webkit-overflow-scrolling: touch;
        }
        .ai-msg {
        padding: 10px 15px; border-radius: 8px; margin-bottom: 10px;
        max-width: 90%; word-wrap: break-word; line-height: 1.5;
        ...
        .ai-msg.error { background: rgba(255, 0, 0, 0.2); color: #ffcccc; align-self: center; }
        .ai-msg.loading { color: #00ffff; font-style: italic; text-align: center; }
        #ai-chat-input { display: flex; gap: 8px; padding: 10px; border-top: 1px solid rgba(0, 255, 255, 0.2); }
        #ai-input {
        flex: 1; padding: 10px 15px; border-radius: 5px;
        border: 1px solid rgba(0, 255, 255, 0.4);
        background: transparent; color: #ccffff; outline: none; font-size: 14px; font-family: inherit;
        }
        #ai-input:focus { border-color: #00ffff; box-shadow: 0 0 10px rgba(0, 255, 255, 0.5); }
        #ai-send {
        padding: 10px 18px; background: #00ffff; color: #0a192f;
        border: none; border-radius: 5px; cursor: pointer; font-weight: bold;
        transition: all 0.3s ease; font-family: inherit;
        }
        #ai-send:hover { background: #ccffff; }
        #ai-send:disabled { background: #555; color: #888; cursor: not-allowed; }
        .ai-typing-indicator span {
        display: inline-block; width: 8px; height: 8px; border-radius: 50%;
        background: #00ffff; margin: 0 2px;
        animation: cyber-typing 1.2s infinite ease-in-out;
        }
